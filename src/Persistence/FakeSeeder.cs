...
public class FakeSeeder
{
	...
	private void SeedTeamMembers()
	{
		...
		{
			new Doctor("Ozlem", "Kose", new DateOnly(1990,4,4), "0495741468", "doctor1@gmail.com"),
            new Doctor("Eline", "De Pauw", new DateOnly(1990,4,4), "0495741468", "doctor1@gmail.com"),
            new Doctor("Diete", "Paternoster", new DateOnly(1990,4,4), "0495741468", "doctor1@gmail.com"),
